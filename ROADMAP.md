...
- [x] **Phase G.12 — Layman-first simplification: "hide the vocabulary, keep the moments" (shipped 2026-09-19)** — UI and copy reorganisation only; no execution, SIP, risk-tier or executor changes.
  ...
  - [ ] Remaining from AIXIN_VS_PAA.md: Priority 2 compensation registry + undo; Priority 3 known-targets allowlist; Priority 4 escalation-pair metrics; then standing grants, trust labels, miss log, three-valued outcomes.
